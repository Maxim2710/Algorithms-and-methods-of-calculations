...
[Реализация разложения в ряд Фурье(коэффиценты разложения вычисляются с помощью численного интегрирования - методом Симпсона)](laboratory_work5/task1/FourierSeries.go)
___
...
[Реализация БПФ](laboratory_work5/task2/FastFourier.go)